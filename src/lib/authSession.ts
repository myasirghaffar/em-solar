...
export const AUTH_STORAGE_KEY = "energymart-auth";
...
export const AUTH_SESSION_UPDATED = "energymart-auth-updated";
...
export async function refreshStoredSession(): Promise<StoredAuth | null> {
  ...
  refreshInFlight = (async () => {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent("energymart-auth-cleared"));
      return null;
    } finally {
