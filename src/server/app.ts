...
/**
 * EnergyMart storefront API — public shop, customer auth, and shop admin.
 * CRM (leads/quotes) lives in em-tools. Mounted under Next.js at `/api/*`.
 */
...
app.get('/', (c) => c.json({ name: 'em-solar-api', ok: true }));
