...
import AdminQuoteTemplates from './pages/admin/QuoteTemplates';
        ...
        >
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/admin/quote-templates" element={<ProtectedRoute allowedRoles={['admin']}><AdminLayout><AdminQuoteTemplates /></AdminLayout></ProtectedRoute>} />
